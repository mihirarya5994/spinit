...
export class ConfettiComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    (function (w) {
      ...
      * Cancel.
      */
      const cancel = w.cancelAnimationFrame || w.webkitCancelAnimationFrame || w.clearTimeout;
    ...
    const Vector2: any = function (_x, _y, _z?) {
    ...
    const ConfettiPaper: any = function (_x, _y) {
    ...
    const ConfettiRibbon: any = function (_x, _y, _count, _dist, _thickness, _angle, _mass, _drag) {
    ...
    const confetti = new Confetti.Context('confetti');
    confetti.start();
